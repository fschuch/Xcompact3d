...
!********************************************************************
!
subroutine derx_00(tx,ux,rx,sx,ffx,fsx,fwx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************

  USE param
  use derivX
  use ibm, only : lagpolx, lagpolx_phi

  implicit none

  integer :: nx,ny,nz,npaire,lagpol,i,j,k
  real(mytype), dimension(nx,ny,nz) :: tx,ux,rx
  real(mytype), dimension(ny,nz):: sx
  real(mytype), dimension(nx):: ffx,fsx,fwx

  if(lagpol.eq.2) call lagpolx(ux)
  if(lagpol.eq.3) call lagpolx_phi(ux)
...
!********************************************************************
!
subroutine derx_11(tx,ux,rx,sx,ffx,fsx,fwx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derx_12(tx,ux,rx,sx,ffx,fsx,fwx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
  ...
  integer :: nx,ny,nz,i,j,k,npaire,lagpol
  real(mytype), dimension(nx,ny,nz) :: tx,ux,rx
  real(mytype), dimension(ny,nz):: sx
  real(mytype), dimension(nx):: ffx,fsx,fwx
...
!********************************************************************
!
subroutine derx_21(tx,ux,rx,sx,ffx,fsx,fwx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derx_22(tx,ux,rx,sx,ffx,fsx,fwx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine dery_00(ty,uy,ry,sy,ffy,fsy,fwy,ppy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************

  USE param
  use derivY
  use ibm, only : lagpoly, lagpoly_phi
  ...
  if(lagpol.eq.2) call lagpoly(uy)
  if(lagpol.eq.3) call lagpoly_phi(uy)
...
!********************************************************************
!
subroutine dery_11(ty,uy,ry,sy,ffy,fsy,fwy,ppy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine dery_12(ty,uy,ry,sy,ffy,fsy,fwy,ppy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine dery_21(ty,uy,ry,sy,ffy,fsy,fwy,ppy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine dery_22(ty,uy,ry,sy,ffy,fsy,fwy,ppy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derz_00(tz,uz,rz,sz,ffz,fsz,fwz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************

  USE param
  use derivZ
  use ibm, only : lagpolz, lagpolz_phi
  ...
  if(lagpol.eq.2) call lagpolz(uz)
  if(lagpol.eq.3) call lagpolz_phi(uz)
...
!********************************************************************
!
subroutine derz_12(tz,uz,rz,sz,ffz,fsz,fwz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derz_21(tz,uz,rz,sz,ffz,fsz,fwz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derz_22(tz,uz,rz,sz,ffz,fsz,fwz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derxx_00(tx,ux,rx,sx,sfx,ssx,swx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derxx_11(tx,ux,rx,sx,sfx,ssx,swx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derxx_12(tx,ux,rx,sx,sfx,ssx,swx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derxx_21(tx,ux,rx,sx,sfx,ssx,swx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derxx_22(tx,ux,rx,sx,sfx,ssx,swx,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine deryy_00(ty,uy,ry,sy,sfy,ssy,swy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine deryy_11(ty,uy,ry,sy,sfy,ssy,swy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine deryy_12(ty,uy,ry,sy,sfy,ssy,swy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine deryy_21(ty,uy,ry,sy,sfy,ssy,swy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine deryy_22(ty,uy,ry,sy,sfy,ssy,swy,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derzz_00(tz,uz,rz,sz,sfz,ssz,swz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derzz_11(tz,uz,rz,sz,sfz,ssz,swz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derzz_12(tz,uz,rz,sz,sfz,ssz,swz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derzz_21(tz,uz,rz,sz,sfz,ssz,swz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
...
!********************************************************************
!
subroutine derzz_22(tz,uz,rz,sz,sfz,ssz,swz,nx,ny,nz,npaire,lagpol)
  !
  !********************************************************************
